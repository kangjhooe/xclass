...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('incoming_letters', function (Blueprint $table) {
            ...
            $table->date('tanggal_disposisi')->nullable()->after('tindak_lanjut');
            $table->string('penerima_disposisi')->nullable()->after('tanggal_disposisi');
    ...
    public function down(): void
    {
        Schema::table('incoming_letters', function (Blueprint $table) {
            ...
            $table->dropIndex(['instansi_id', 'jenis_surat']);
