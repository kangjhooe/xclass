...
export default function TenantDashboard() {
  ...
  const averageGrade = gradesData?.data?.length > 0
  ...
  const isLoading = studentsLoading || teachersLoading || classesLoading || attendanceLoading || gradesLoading;
    ...
    <TenantLayout>
      <div className="p-6 bg-gradient-to-br from-gray-50 via-blue-50/30 to-purple-50/30 min-h-screen">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Selamat datang kembali! Berikut ringkasan data instansi Anda.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="group relative bg-gradient-to-br from-blue-500 to-blue-600 p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 overflow-hidden">
            ...
            <div className="relative flex items-center justify-between">
              <div className="flex-1">
                <h2 className="text-white/90 text-sm font-medium mb-2 uppercase tracking-wide">Total Siswa</h2>
                <p className="text-4xl font-bold text-white mb-1">{totalStudents}</p>
                <p className="text-xs text-white/80">Siswa terdaftar</p>
              </div>
              <div className="ml-4">
            ...
            <Link href={`/${tenantId}/students`} className="absolute inset-0"></Link>
          </div>
          ...
          <div className="group relative bg-gradient-to-br from-emerald-500 to-emerald-600 p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 overflow-hidden">
            ...
            <div className="relative flex items-center justify-between">
              <div className="flex-1">
                <h2 className="text-white/90 text-sm font-medium mb-2 uppercase tracking-wide">Total Guru</h2>
                <p className="text-4xl font-bold text-white mb-1">{totalTeachers}</p>
                <p className="text-xs text-white/80">Guru terdaftar</p>
              </div>
              <div className="ml-4">
                <div className="w-16 h-16 bg-white/20 rounded-xl flex items-center justify-center backdrop-blur-sm">
                  <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <Link href={`/${tenantId}/teachers`} className="absolute inset-0"></Link>
          </div>
          ...
          <div className="group relative bg-gradient-to-br from-purple-500 to-purple-600 p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 overflow-hidden">
            ...
            <div className="relative flex items-center justify-between">
              <div className="flex-1">
                <h2 className="text-white/90 text-sm font-medium mb-2 uppercase tracking-wide">Total Kelas</h2>
                <p className="text-4xl font-bold text-white mb-1">{totalClasses}</p>
                <p className="text-xs text-white/80">Kelas aktif</p>
              </div>
              <div className="ml-4">
                <div className="w-16 h-16 bg-white/20 rounded-xl flex items-center justify-center backdrop-blur-sm">
                  <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <Link href={`/${tenantId}/classes`} className="absolute inset-0"></Link>
          </div>

          {/* Absensi Hari Ini Card */}
          <div className="group relative bg-gradient-to-br from-orange-500 to-orange-600 p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 overflow-hidden">
            <div className="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full -mr-16 -mt-16"></div>
            <div className="absolute bottom-0 left-0 w-24 h-24 bg-white/10 rounded-full -ml-12 -mb-12"></div>
            <div className="relative flex items-center justify-between">
              <div className="flex-1">
                <h2 className="text-white/90 text-sm font-medium mb-2 uppercase tracking-wide">Kehadiran Hari Ini</h2>
                <p className="text-4xl font-bold text-white mb-1">{attendanceRate}%</p>
                <div className="flex gap-3 text-xs mt-2">
                  <span className="text-white/90">Hadir: <span className="font-semibold">{presentToday}</span></span>
                  <span className="text-white/90">Tidak: <span className="font-semibold">{absentToday}</span></span>
                </div>
              </div>
              <div className="ml-4">
                <div className="w-16 h-16 bg-white/20 rounded-xl flex items-center justify-center backdrop-blur-sm">
            ...
            <Link href={`/${tenantId}/attendance`} className="absolute inset-0"></Link>
          </div>
        </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-cyan-600">{totalAttendance}</p>
              </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-amber-600">{lateToday}</p>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {/* Quick Actions */}
          <div className="lg:col-span-1 bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
            ...
            <div className="p-6 space-y-3">
              <Link
                href={`/${tenantId}/students`}
                className="flex items-center gap-3 p-4 border border-gray-200 rounded-xl hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50 transition-all duration-200 hover:shadow-md group"
              >
                ...
                <span className="font-medium text-gray-700 group-hover:text-blue-600 transition-colors">Tambah Siswa</span>
              </Link>

              <Link
                href={`/${tenantId}/attendance`}
                className="flex items-center gap-3 p-4 border border-gray-200 rounded-xl hover:bg-gradient-to-r hover:from-green-50 hover:to-emerald-50 transition-all duration-200 hover:shadow-md group"
              >
                ...
                <span className="font-medium text-gray-700 group-hover:text-green-600 transition-colors">Input Absensi</span>
              </Link>

              <Link
                href={`/${tenantId}/grades`}
                className="flex items-center gap-3 p-4 border border-gray-200 rounded-xl hover:bg-gradient-to-r hover:from-purple-50 hover:to-pink-50 transition-all duration-200 hover:shadow-md group"
              >
                ...
                <span className="font-medium text-gray-700 group-hover:text-purple-600 transition-colors">Input Nilai</span>
              </Link>

              <Link
                href={`/${tenantId}/classes`}
                className="flex items-center gap-3 p-4 border border-gray-200 rounded-xl hover:bg-gradient-to-r hover:from-orange-50 hover:to-amber-50 transition-all duration-200 hover:shadow-md group"
              >
                ...
                <span className="font-medium text-gray-700 group-hover:text-orange-600 transition-colors">Kelola Kelas</span>
              </Link>
            </div>
          </div>

          {/* Recent Students */}
          <div className="lg:col-span-2 bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
            <div className="p-6 bg-gradient-to-r from-blue-50 to-purple-50 border-b border-gray-200 flex justify-between items-center">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-xl font-bold text-gray-800">Siswa Terbaru</h2>
              </div>
              <Link
                href={`/${tenantId}/students`}
                ...
                <div className="space-y-3">
                  {recentStudents.map((student: any) => (
                    ...
                    >
                      <div className="flex items-center gap-4 flex-1">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="text-sm text-gray-500 mt-1">
                            ...
                            <span className="font-medium ml-2">Kelas:</span> {student.class?.name || '-'}
                          </div>
                          {student.createdAt && (
                      ...
                      <span className="px-3 py-1.5 text-xs font-bold rounded-full bg-gradient-to-r from-blue-500 to-purple-500 text-white shadow-sm">
                        Aktif
                      </span>
                    </div>
                  ))}
