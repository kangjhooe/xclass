        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ tenant_route('facility.buildings.update', $building->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('land_id') is-invalid @enderror" 
                                        ...
                                        @foreach($lands as $land)
                                            <option value="{{ $land->id }}" {{ old('land_id', $building->land_id) == $land->id ? 'selected' : '' }}>
                                                {{ $land->name }} 
                                                @if($land->location)
                                                    - {{ $land->location }}
                                                @endif
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('floors') is-invalid @enderror" 
                                           id="floors" name="floors" value="{{ old('floors', $building->floors) }}" min="1" required>
                                    @error('floors')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('built_year') is-invalid @enderror" 
                                           id="built_year" name="built_year" value="{{ old('built_year', $building->built_year ?? '') }}" 
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('length') is-invalid @enderror" 
                                           id="length" name="length" value="{{ old('length', $building->length ?? '') }}" 
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('width') is-invalid @enderror" 
                                           id="width" name="width" value="{{ old('width', $building->width ?? '') }}" 
                                           step="0.01" min="0" placeholder="0.00">
                                    @error('width')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('status') is-invalid @enderror" 
                                        ...
                                        <option value="baik" {{ old('status', $building->status) == 'baik' ? 'selected' : '' }}>Baik</option>
                                        <option value="rusak_ringan" {{ old('status', $building->status) == 'rusak_ringan' ? 'selected' : '' }}>Rusak Ringan</option>
                                        <option value="rusak_berat" {{ old('status', $building->status) == 'rusak_berat' ? 'selected' : '' }}>Rusak Berat</option>
                                        <option value="rusak_total" {{ old('status', $building->status) == 'rusak_total' ? 'selected' : '' }}>Rusak Total</option>
                                    </select>
                                    @error('status')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      id="description" name="description" rows="4">{{ old('description', $building->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            <a href="{{ tenant_route('facility.buildings.show', $building->id) }}" class="btn btn-secondary">
