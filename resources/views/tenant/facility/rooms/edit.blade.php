        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ tenant_route('facility.rooms.update', $room->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('type') is-invalid @enderror" 
                                        ...
                                        <option value="classroom" {{ old('type', $room->type) == 'classroom' ? 'selected' : '' }}>Kelas</option>
                                        <option value="office" {{ old('type', $room->type) == 'office' ? 'selected' : '' }}>Kantor</option>
                                        <option value="library" {{ old('type', $room->type) == 'library' ? 'selected' : '' }}>Perpustakaan</option>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('floor') is-invalid @enderror" 
                                           id="floor" name="floor" value="{{ old('floor', $room->floor) }}" min="0" required>
                                    @error('floor')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('length') is-invalid @enderror" 
                                           id="length" name="length" value="{{ old('length', $room->length ?? '') }}" min="0" step="0.01" placeholder="0.00">
                                    @error('length')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('width') is-invalid @enderror" 
                                           id="width" name="width" value="{{ old('width', $room->width ?? '') }}" min="0" step="0.01" placeholder="0.00">
                                    @error('width')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            <a href="{{ tenant_route('facility.rooms.show', $room->id) }}" class="btn btn-secondary">
