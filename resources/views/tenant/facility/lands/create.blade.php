...
@section('page-title', 'Tambah Lahan')
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ tenant_route('facility.lands.store') }}" method="POST">
                        @csrf
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('area') is-invalid @enderror" 
                                           id="area" name="area" value="{{ old('area') }}" step="0.01" min="0" required>
                                    @error('area')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('area_unit') is-invalid @enderror" 
                                        ...
                                        <option value="hectare" {{ old('area_unit') == 'hectare' ? 'selected' : '' }}>Hektar</option>
                                    </select>
                                    @error('area_unit')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('location') is-invalid @enderror" 
                                           id="location" name="location" value="{{ old('location') }}" placeholder="Opsional">
                                    @error('location')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      id="description" name="description" rows="3" placeholder="Opsional">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="ownershipHeading">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" 
                                            data-bs-target="#ownershipCollapse" aria-expanded="false" aria-controls="ownershipCollapse">
                                        <i class="fas fa-file-contract me-2"></i>
                                        Informasi Kepemilikan (Opsional)
                                    </button>
                                </h2>
                                <div id="ownershipCollapse" class="accordion-collapse collapse" 
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control @error('ownership_type') is-invalid @enderror" 
                                                           id="ownership_type" name="ownership_type" value="{{ old('ownership_type') }}" 
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control @error('ownership_number') is-invalid @enderror" 
                                                           id="ownership_number" name="ownership_number" value="{{ old('ownership_number') }}">
