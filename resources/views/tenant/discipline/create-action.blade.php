...
@section('title', 'Tambah Tindakan Disiplin')
@section('page-title', 'Tambah Tindakan Disiplin')
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="page-header">
                ...
                <p class="text-muted mb-0">Isi form di bawah untuk menambahkan tindakan disiplin baru</p>
            </div>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="form-card">
                <div class="form-card-header">
                    ...
                    Form Tambah Tindakan Disiplin
                </div>
                <form action="{{ tenant_route('discipline.actions.store') }}" method="POST">
                    @csrf
                    <div class="card-body p-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="violation_type" id="violation_type" class="form-select @error('violation_type') is-invalid @enderror" required>
                                    ...
                                    <option value="minor" {{ old('violation_type') == 'minor' ? 'selected' : '' }}>Ringan</option>
                                    <option value="moderate" {{ old('violation_type') == 'moderate' ? 'selected' : '' }}>Sedang</option>
                                    <option value="major" {{ old('violation_type') == 'major' ? 'selected' : '' }}>Berat</option>
                                    <option value="severe" {{ old('violation_type') == 'severe' ? 'selected' : '' }}>Sangat Berat</option>
                                </select>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="violation_category" id="violation_category" class="form-select @error('violation_category') is-invalid @enderror" required>
                                    ...
                                    <option value="academic" {{ old('violation_category') == 'academic' ? 'selected' : '' }}>Akademik</option>
                                    <option value="behavior" {{ old('violation_category') == 'behavior' ? 'selected' : '' }}>Perilaku</option>
                                    <option value="attendance" {{ old('violation_category') == 'attendance' ? 'selected' : '' }}>Kehadiran</option>
                                    <option value="dress_code" {{ old('violation_category') == 'dress_code' ? 'selected' : '' }}>Seragam</option>
                                    <option value="safety" {{ old('violation_category') == 'safety' ? 'selected' : '' }}>Keamanan</option>
                                    <option value="other" {{ old('violation_category') == 'other' ? 'selected' : '' }}>Lainnya</option>
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="severity_level" id="severity_level" class="form-select @error('severity_level') is-invalid @enderror" required>
                                    ...
                                    <option value="low" {{ old('severity_level') == 'low' ? 'selected' : '' }}>Rendah</option>
                                    <option value="medium" {{ old('severity_level') == 'medium' ? 'selected' : '' }}>Sedang</option>
                                    <option value="high" {{ old('severity_level') == 'high' ? 'selected' : '' }}>Tinggi</option>
                                    <option value="critical" {{ old('severity_level') == 'critical' ? 'selected' : '' }}>Kritis</option>
                                </select>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="sanction_type" id="sanction_type" class="form-select @error('sanction_type') is-invalid @enderror" required>
                                    ...
                                    <option value="warning" {{ old('sanction_type') == 'warning' ? 'selected' : '' }}>Peringatan</option>
                                    <option value="reprimand" {{ old('sanction_type') == 'reprimand' ? 'selected' : '' }}>Teguran</option>
                                    <option value="detention" {{ old('sanction_type') == 'detention' ? 'selected' : '' }}>Hukuman</option>
                                    <option value="suspension" {{ old('sanction_type') == 'suspension' ? 'selected' : '' }}>Skorsing</option>
                                    <option value="expulsion" {{ old('sanction_type') == 'expulsion' ? 'selected' : '' }}>Dikeluarkan</option>
                                    <option value="community_service" {{ old('sanction_type') == 'community_service' ? 'selected' : '' }}>Layanan Masyarakat</option>
                                </select>
                                @error('sanction_type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="sanction_description" id="sanction_description" 
                                      ...
                                      rows="3" 
                                      placeholder="Jelaskan tindakan yang diberikan (opsional)">{{ old('sanction_description') }}</textarea>
