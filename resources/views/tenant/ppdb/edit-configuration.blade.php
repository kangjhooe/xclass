...
@section('title', 'Edit Konfigurasi PPDB/SPMB')
...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">
                    <i class="fas fa-edit me-2"></i>Edit Konfigurasi PPDB/SPMB
                </h4>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ tenant_route('tenant.ppdb.configuration.update', $configuration) }}" method="POST">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="academic_year" name="academic_year" 
                                           value="{{ old('academic_year', $configuration->academic_year) }}" placeholder="2024/2025" required>
                                    @error('academic_year')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="batch_name" name="batch_name" 
                                           value="{{ old('batch_name', $configuration->batch_name) }}" placeholder="Gelombang 1" required>
                                    @error('batch_name')
                                        <div class="text-danger small">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" id="registration_start" name="registration_start" 
                                           value="{{ old('registration_start', $configuration->registration_start?->format('Y-m-d')) }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" id="registration_end" name="registration_end" 
                                           value="{{ old('registration_end', $configuration->registration_end?->format('Y-m-d')) }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" id="announcement_date" name="announcement_date" 
                                           value="{{ old('announcement_date', $configuration->announcement_date?->format('Y-m-d')) }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" id="re_registration_start" name="re_registration_start" 
                                           value="{{ old('re_registration_start', $configuration->re_registration_start?->format('Y-m-d')) }}" required>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" id="re_registration_end" name="re_registration_end" 
                                           value="{{ old('re_registration_end', $configuration->re_registration_end?->format('Y-m-d')) }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="available_majors_text" placeholder="Mis: RPL, TKJ, AKL"
                                           value="{{ old('available_majors_text', isset($configuration->available_majors) ? implode(', ', $configuration->available_majors) : '') }}">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="admission_paths_text" placeholder="Mis: Zonasi, Prestasi, Afirmasi, Umum"
                                           value="{{ old('admission_paths_text', isset($configuration->admission_paths) ? implode(', ', $configuration->admission_paths) : '') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="quotas_json" rows="4" placeholder='Contoh: {"RPL": {"Zonasi": 20, "Prestasi": 10}, "TKJ": {"Umum": 36}}'>{{ old('quotas_json', $configuration->quotas ? json_encode($configuration->quotas) : '') }}</textarea>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="max_applications" name="max_applications" 
                                           value="{{ old('max_applications', $configuration->max_applications) }}" min="1" placeholder="Kosongkan untuk tidak terbatas">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="registration_fee" name="registration_fee" 
                                           value="{{ old('registration_fee', $configuration->registration_fee) }}" min="0" step="1000" placeholder="0">
                                ...
                                <div class="mb-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="auto_approval" name="auto_approval" 
                                               {{ old('auto_approval', $configuration->auto_approval) ? 'checked' : '' }}>
                                ...
                                <div class="mb-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="is_active" name="is_active" 
                                               value="1" {{ old('is_active', $configuration->is_active) ? 'checked' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="description" name="description" rows="3" 
                                      placeholder="Tambahkan deskripsi konfigurasi PPDB">{{ old('description', $configuration->description) }}</textarea>
                            @error('description')
                                <div class="text-danger small">{{ $message }}</div>
                            @enderror
                        </div>
