...
<div class="row">
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ tenant_route('tenant.student-grades.store') }}" method="POST">
                    @csrf
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('assignment_name') is-invalid @enderror" 
                                       id="assignment_name" name="assignment_name" value="{{ old('assignment_name') }}" 
    ...
    <div class="col-md-4">
        <div class="card">
            ...
            <div class="card-body">
                <p class="mb-3">
                    <strong>Jenis Penilaian:</strong>
                </p>
                <ul class="mb-3">
                    <li><strong>Tugas:</strong> Tugas harian, PR, dll</li>
                    <li><strong>UTS:</strong> Ujian Tengah Semester</li>
                    <li><strong>UAS:</strong> Ujian Akhir Semester</li>
                    <li><strong>Kuis:</strong> Kuis singkat</li>
                    <li><strong>Proyek:</strong> Tugas proyek</li>
                </ul>
                <p class="mb-3">
                    <strong>Nilai Akhir:</strong> Akan dihitung otomatis berdasarkan bobot yang ditetapkan.
                </p>
                <p class="mb-0">
                    <strong>KKM:</strong> Kriteria Ketuntasan Minimal adalah 60.
                </p>
            </div>
        </div>
    </div>
