        ...
        <div class="col-12">
            <div class="modern-card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ tenant_route('transportation.routes.update', $route->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      placeholder="Deskripsikan rute transportasi">{{ old('description', $route->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
