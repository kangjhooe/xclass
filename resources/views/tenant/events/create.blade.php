...
<div class="page-header-modern fade-in-up">
    <div class="row align-items-center">
        <div class="col-md-8">
            ...
            <p>Buat event baru untuk sekolah</p>
        </div>
...
<div class="card-modern fade-in-up fade-in-up-delay-5">
    ...
    <div class="card-body">
        ...
        <form action="{{ tenant_route('tenant.events.store') }}" method="POST">
            @csrf
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('type') is-invalid @enderror" 
                                ...
                                <option value="sports" {{ old('type') == 'sports' ? 'selected' : '' }}>Olahraga</option>
                                <option value="cultural" {{ old('type') == 'cultural' ? 'selected' : '' }}>Budaya</option>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Show recurring options if already checked
