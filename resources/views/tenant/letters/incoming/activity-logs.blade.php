...
@section('title', 'Riwayat Aktivitas Surat Masuk')
                ...
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h3 class="card-title mb-0">
                            ...
                            Riwayat Aktivitas - {{ $incomingLetter->nomor_surat }}
                        </h3>
                        <a href="{{ tenant_route('letters.incoming.show', $incomingLetter) }}" class="btn btn-secondary">
