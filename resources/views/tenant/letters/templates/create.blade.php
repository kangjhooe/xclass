    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ tenant_route('letters.templates.store') }}" id="templateForm">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="hidden" name="variables_json" id="variables_json" value="{{ old('variables_json', '[]') }}">
                                </div>
                            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    selectedVariables = existingVariables;
...
function previewTemplate() {
    ...
    fetch('{{ route("tenant.letters.templates.preview", ":id") }}'.replace(':id', 'preview'), {
        method: 'POST',
        headers: {
