...
<div class="page-header-modern fade-in-up">
    <div class="row align-items-center">
        <div class="col-md-8">
            ...
            <p>Buat mata pelajaran baru untuk sekolah</p>
        </div>
...
<div class="row">
    <div class="col-lg-8">
        <div class="card-modern fade-in-up fade-in-up-delay-5">
            ...
            <div class="card-body">
                <form action="{{ tenant_route('tenant.subjects.store') }}" method="POST">
                    @csrf
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('credits') is-invalid @enderror" 
                                       id="credits" name="credits" value="{{ old('credits', 1) }}" 
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <select class="form-control @error('category') is-invalid @enderror" 
                                    ...
                                    <option value="Kejuruan" {{ old('category') == 'Kejuruan' ? 'selected' : '' }}>Kejuruan</option>
                                    <option value="Pilihan" {{ old('category') == 'Pilihan' ? 'selected' : '' }}>Pilihan</option>
                                </select>
                                @error('category')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
    ...
    <div class="col-md-4">
        <div class="card">
            ...
            <div class="card-body">
                <p class="text-muted">
                    <strong>Kode Mata Pelajaran:</strong> Gunakan kode unik untuk setiap mata pelajaran (contoh: MAT, FIS, KIM).
                </p>
                <p class="text-muted">
                    <strong>SKS:</strong> Jumlah Satuan Kredit Semester yang akan diberikan untuk mata pelajaran ini.
                </p>
                <p class="text-muted">
                    <strong>Level:</strong> Tingkat pendidikan yang sesuai dengan mata pelajaran.
                </p>
            </div>
        </div>
    </div>
