        ...
        <div class="col-12">
            <div class="modern-card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ tenant_route('health.records.update', $record->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6">
                                    ...
                                    <select class="form-select @error('student_id') is-invalid @enderror" 
                                        ...
                                        @foreach($students as $student)
                                            <option value="{{ $student->id }}" 
                                                    {{ old('student_id', $record->student_id) == $student->id ? 'selected' : '' }}>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control @error('checkup_date') is-invalid @enderror" 
                                           ...
                                           value="{{ old('checkup_date', \Carbon\Carbon::parse($record->checkup_date)->format('Y-m-d')) }}" required>
                                    @error('checkup_date')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('health_status') is-invalid @enderror" 
                                        ...
                                        <option value="healthy" {{ old('health_status', $record->health_status) == 'healthy' ? 'selected' : '' }}>Sehat</option>
                                        <option value="sick" {{ old('health_status', $record->health_status) == 'sick' ? 'selected' : '' }}>Sakit</option>
                                        <option value="recovering" {{ old('health_status', $record->health_status) == 'recovering' ? 'selected' : '' }}>Pulih</option>
                                    </select>
                                    @error('health_status')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('height') is-invalid @enderror" 
                                           id="height" name="height" value="{{ old('height', $record->height) }}" min="0" step="0.1">
                                    @error('height')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('weight') is-invalid @enderror" 
                                           id="weight" name="weight" value="{{ old('weight', $record->weight) }}" min="0" step="0.1">
                                    @error('weight')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('temperature') is-invalid @enderror" 
                                           id="temperature" name="temperature" value="{{ old('temperature', $record->temperature) }}" 
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <div id="symptoms-editor-container">
                                        <textarea class="form-control @error('symptoms') is-invalid @enderror" 
                                                  id="symptoms" name="symptoms" rows="3" 
                                                  placeholder="Deskripsikan gejala yang dialami">{{ old('symptoms', $record->symptoms) }}</textarea>
                                    </div>
                                    @error('symptoms')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <div id="diagnosis-editor-container">
                                        <textarea class="form-control @error('diagnosis') is-invalid @enderror" 
                                                  id="diagnosis" name="diagnosis" rows="3" 
                                                  placeholder="Diagnosis medis">{{ old('diagnosis', $record->diagnosis) }}</textarea>
                                    </div>
                                    @error('diagnosis')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <div id="treatment-editor-container">
                                        <textarea class="form-control @error('treatment') is-invalid @enderror" 
                                                  id="treatment" name="treatment" rows="3" 
                                                  placeholder="Perawatan yang diberikan">{{ old('treatment', $record->treatment) }}</textarea>
                                    </div>
                                    @error('treatment')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <div id="medication-editor-container">
                                        <textarea class="form-control @error('medication') is-invalid @enderror" 
                                                  id="medication" name="medication" rows="3" 
                                                  placeholder="Obat-obatan yang diberikan">{{ old('medication', $record->medication) }}</textarea>
                                    </div>
                                    @error('medication')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control @error('follow_up_date') is-invalid @enderror" 
                                           ...
                                           value="{{ old('follow_up_date', $record->follow_up_date ? \Carbon\Carbon::parse($record->follow_up_date)->format('Y-m-d') : '') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('notes') is-invalid @enderror" 
                                      ...
                                      placeholder="Catatan tambahan tentang kondisi kesehatan siswa">{{ old('notes', $record->notes) }}</textarea>
                            @error('notes')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
