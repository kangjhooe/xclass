        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ tenant_route('hr.employees.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    <label for="employee_number" class="form-label">Nomor Karyawan <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    <label for="hire_date" class="form-label">Tanggal Mulai Bekerja <span class="text-danger">*</span></label>
                                ...
                                <div class="mb-3">
                                    <label for="salary" class="form-label">Gaji Pokok <span class="text-danger">*</span></label>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('address') is-invalid @enderror" 
                                      ...
                                      placeholder="Tuliskan alamat lengkap di sini">{{ old('address') }}</textarea>
                            @error('address')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            <a href="{{ tenant_route('hr.employees') }}" class="btn btn-secondary">
