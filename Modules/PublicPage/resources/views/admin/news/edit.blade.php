    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ tenant_route('admin.news.update', $news->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div id="drop-zone" 
                                             ...
                                             style="min-height: 200px; cursor: pointer; transition: all 0.3s; {{ $news->featured_image ? 'display: none;' : '' }}"
                                            ...
                                            <div id="drop-zone-content">
                                                ...
                                                <p class="mb-2">
                                                    <strong>{{ $news->featured_image ? 'Ganti gambar' : 'Seret dan lepas gambar di sini' }}</strong>
                                                </p>
                                            ...
                                            <div class="row g-3">
                                                <div class="col-6">
                                                    <div class="text-center p-2 bg-light rounded">
                                                        ...
                                                        <div class="fw-bold fs-5">{{ number_format($news->view_count) }}</div>
                                                ...
                                                <div class="col-6">
                                                    <div class="text-center p-2 bg-light rounded">
                                                        ...
                                                        <div class="fw-bold fs-5">{{ $news->reading_time }}</div>
                                                ...
                                                <div class="col-6">
                                                    <div class="text-center p-2 bg-light rounded">
                                                        ...
                                                        <div class="fw-bold fs-6">{{ $news->formatted_created_date }}</div>
                                                ...
                                                <div class="col-6">
                                                    <div class="text-center p-2 bg-light rounded">
                                                        ...
                                                        <div class="fw-bold fs-6">{{ $news->formatted_published_date ?? '-' }}</div>
...
<script>
    ...
    // Note: For edit mode, we don't auto-generate excerpt since it might already have content
