...
@section('title', 'Preview Profile Instansi')
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                        ...
                        Preview Profile Instansi
                    </h3>
                    <div class="card-tools">
                        <a href="{{ route('tenant.public-page.profile.show', ['tenant' => request()->route('tenant')]) }}" class="btn btn-primary btn-sm">
                            <i class="fas fa-edit mr-1"></i>
                            Edit Profile
                        </a>
                        <a href="{{ route('tenant.public-page.profile.edit', ['tenant' => request()->route('tenant')]) }}" class="btn btn-secondary btn-sm ml-2">
                ...
                <div class="card-body">
                    <div class="alert alert-info">
                        ...
                        <strong>Preview Mode:</strong> Ini adalah tampilan preview dari profile instansi Anda. 
                        Perubahan belum disimpan hingga Anda menekan tombol "Simpan Perubahan".
                    </div>
